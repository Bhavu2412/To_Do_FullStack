...
export default function Login(){
    ...
    function sendData(value , password){
        ...
        axios.post('https://todo-list-ywe3.onrender.com/login',{[value] : data.InputValue  , password:password})
        .then(res=>{
    ...
    return (
       <>
        <div className="container-login">
            <h1 id="head"><b>Login to ToDo</b></h1>
            <br/>
            ...
            <div className="login" id="login">
                ...
                <p id="email"> <b>Email or username</b></p>
                <input id="inpemail" type="text"  value={data.InputValue} name='InputValue' onChange={handleInput} />
                <p id="pass"> <b>Password</b></p>
                <input id="inppass" type="password" name="password" value={data.password} onChange={handleInput} />
                <br/>
                <button type="submit" id="submit" ><b>Log in </b></button>
                <br/>
                <br/>
                <p className="forget" onClick={handleForgetClick}><b>Forgot Password? </b></p>
                <br/>
                </form>
                <hr width="425vw" />
            </div>
            ...
            <div className="signup">
                <p id="don"><b>Don't have an account? </b></p>
                <p id="signup" onClick={handleSignupClick}><b>Sign up for ToDo</b></p>
            </div>
        </div>
            {
