    ...
    <>
      <div className="container-forgetpass">
        <form onSubmit={handleSubmit}>
          <p className="p-forgetpass">
            <b>Enter your email</b>
          </p>
          <input
            type="email"
            className="input-forgetpass"
            name="email"
            value={email}
            ...
            <div className="password-input">
              ...
              <div className="input-forget">
                ...
                <input
                  type="text"
                  name="againpassword"
                  value={newpass.passaga}
                  onChange={(e) => {
                    setNewPass({ ...newpass, passaga: e.target.value });
                  }}
                  className="otp-input2"
                />
              </div>
      ...
      {err && (
        <Popup
          ...
          message={"please chek your password again"}
          show={err}
          setShow={setErr}
        />
      )}
      {err2 && (
        <Popup
          title={"Password is of length less then 5"}
          message={"please chek your password again"}
          show={err2}
          setShow={setErr2}
        />
